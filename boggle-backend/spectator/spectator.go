...
var endpoint string = "localhost:9092"

var debug bool

type SpectatorWSClient struct {
	Conn           *websocket.Conn
	UniqueNumber   int
...
func (c * SpectatorWSClient) newSpectator(ctx context.Context, topic string) {
...
func (c *SpectatorWSClient) HandleClient() {
    defer c.Conn.Close()
...
func HandleSpectatorConnections(w http.ResponseWriter, r *http.Request) {
